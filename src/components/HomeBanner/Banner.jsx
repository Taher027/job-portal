    ...
    <div className="  bg-banner-bg bg-cover bg-center h-auto  bg-white ">
      <Container>
        <div className="md:py-20 py-14">
          ...
          <form>
            <div className=" flex  flex-col justify-start gap-4 md:flex-row md:gap-0 w-full">
              ...
              <div className=" w-full flex  md:rounded-s-none shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 ">
                <input
                  type="text"
                  name="title"
                  id="title"
